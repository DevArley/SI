<%@ page language="java" contentType="text/html; charset=UTF-8" %>
    ...
    <a href="formatosGrado.jsp"><i class="fas fa-file-alt"></i> Formatos de Grado</a>
                                ...
                                <div class="main-content">
                                    <h1>Bienvenido, Director
                                        <c:out value="${sessionScope.user.nombres}" />
                                    </h1>
...
<sql:query var="result" scope="request" dataSource="${conexionSI}">
    SELECT id, titulo, descripcion, url, estado_director, id_estudiante1, id_estudiante2, id_evaluador, fecha_creacion, estado 
    FROM proyecto
    WHERE id_director = ?
                                ...
                                <div class="modal-body">
                                    <form action="asignarEstado.jsp" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="estado_director" name="estado_director">
                                                <option value="pendiente" ${fila.estado_director == 'pendiente' ? 'selected' : ''}>Pendiente</option>
                                                <option value="calificado" ${fila.estado_director == 'aprobado' ? 'selected' : ''}>Calificado</option>
                                                <option value="rechazado" ${fila.estado_director == 'rechazado' ? 'selected' : ''}>Rechazado</option>
                                            </select>
                                        </div>
