                                        ...
                                        <div class="col-md-12">
                                            <div class="card"style="width: 1092px;">
                                                <div class="card-body text-center">
                                                    <h5 class="card-title">Editar y actualizar datos de Proyecto</h5>
                                                </div>
    <div class="container">
        ...
        <div class="card-body"style="width: 1051px;">
                            ...
                            <table class="table">
                                <c:forEach var="item" items="${proyecto.rows}">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: rgb(163, 163, 163);"><input style="width: 830px; transform: translate(13px, 0px); color: rgb(5, 5, 5); background-color: rgb(252, 252, 252);" type="text" name="titulo" value="${item.titulo}" required /></td>
                                    </tr>
                                    <tr>
                                        <td style="background-color: rgb(34, 28, 28); color: rgb(255, 255, 255);">Descripción:</td>
                                        <td><textarea name="descripcion" required style="width: 832px; transform: translate(13px, 0px); height: 164px;">${item.descripcion}</textarea></td>
                                    </tr>
                                    <tr>
                                        <td style="background-color: rgb(34, 28, 28); color: rgb(255, 255, 255);">URL:</td>
                                        <td style="background-color: rgb(163, 163, 163);"><input style="width: 828px; transform: translate(16px, 0px); height: 35px; color: rgb(18, 17, 17); background-color: rgb(247, 243, 243);" type="url" name="url" value="${item.url}" /></td>
                                    </tr>
            ...
            <c:if test="${param.modifica != null}">
                ...
                <c:if test="${result == 1}">
    <script>
        window.location.href = 'index.jsp?status=proUpdate';
    </script>
</c:if>

<c:if test="${result != 1}">
<script>
        window.location.href = 'index.jsp?status=ErrorproUd';
    </script>
</c:if>
            </c:if>
        </div>
