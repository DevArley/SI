        ...
        <div class="card-body"style="width: 1051px;">
            ...
            <c:if test="${param.modifica == null}">
                <sql:query var="proyecto" dataSource="${conexionSI}">
                    SELECT * FROM formatos_grado WHERE id = ?;
                            ...
                            <table class="table">
                                <c:forEach var="item" items="${proyecto.rows}">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: rgb(163, 163, 163);"><input style="width: 828px; transform: translate(16px, 0px); height: 35px; color: rgb(18, 17, 17); background-color: rgb(247, 243, 243);" type="url_formato" name="url_formato" value="${item.url_formato}" /></td>
                                    </tr>
            ...
            <c:if test="${param.modifica != null}">
                ...
                <c:if test="${result == 1}">
    <script>
        window.location.href = 'formatosGrado.jsp?status=successedit';
    </script>
</c:if>

<c:if test="${result != 1}">
<script>
        window.location.href = 'formatosGrado.jsp?status=erroredit';
    </script>
</c:if>
            </c:if>
        </div>
